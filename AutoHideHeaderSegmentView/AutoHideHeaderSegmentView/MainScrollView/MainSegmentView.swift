...
//    @objc optional func mainSegmentView(_ mainSegmentView: MainSegmentView, didSelectedat index: Int)
//
...
//
//    /// 返回当前index位置pageView
//    @objc func mainSegmentView(mainSegmentView: MainSegmentView, subScrollViewFor index: Int) -> UIScrollView
//
//    /// 返回segmentBar的全部标题
//    /// 不使用自定义 barItem 时必须实现
//    @objc optional func subTitleForPages(mainSegmentView: MainSegmentView) -> [String]
//
//    /// 返回自定义 baritem
//    /// 使用自定义 barItem 时必须实现
//    @objc optional func mainSegmentView(mainSegmentView: MainSegmentView, barItemFor indexPath: IndexPath) -> UICollectionViewCell
//
//    /// 返回页数
//    /// 使用自定义 barItem 时必须实现
//    @objc optional func numberOfPages(mainSegmentView: MainSegmentView) -> Int
//
////    /// 返回 barItem width
////    @objc optional func mainSegmentView(mainSegmentView: MainSegmentView, barWidthForIndex: Int) -> CGFloat
//
//    /// 返回barItem 移动背景
//    @objc optional func segmentBarAutoContainerView(mainSegmentView: MainSegmentView ) -> UIView?
//
//    /// 返回 barItem width
//    @objc optional func segmentBarItemWidth(mainSegmentView: MainSegmentView) -> CGFloat
//}
//
//
//
...
//
//    // MARK: 代理
//    weak var delegate: AutoHideHeaderSegmentDelegate?
//
//
//    // MARK: 数据源
//    weak var dataSource: AutoHideHeaderSegmentDataSource?
//
//
//    // MARK: 头部最大滚动高度
